...
export default function PricingPage() {
  ...
  /* =======================================================
     ADD DUMMY BILLING RECORD
  ======================================================= */

  const addDummyBillingRecord = (
    plan: Plan
  ) => {
  ...
  const handleSubscribe = async (
    ...
    try {
      ...
      if (paymentMethod !== 'stripe') {
        setMessage(
          `${paymentMethod === 'paypal' ? 'PayPal' : 'Wise'} selected. Using demo payment mode for now.`
        );
      }
      ...
      /* -----------------------------------------------
         ...
         No Stripe / PayPal / Wise API is called.
      ------------------------------------------------ */

      setMessage(
        `Processing your ${plan.name} payment...`
      );
                ...
                <div className="mt-2 space-y-1">
                  ...
                  {subscription.is_trial &&
                    subscription.trial_ends_at && (
                      <p className="text-xs text-amber-600 font-bold">
                        Trial ends:{' '}
                        {subscription.trial_ends_at.slice(
                          0,
                          10
                        )}
                      </p>
                  ...
                  {subscription.renewal_date && (
                    <p className="text-xs text-slate-500">
                      ...
                      <span className="font-bold text-slate-900">
                        {subscription.renewal_date.slice(
                          0,
                          10
                        )}
                      </span>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-5">
          ...
          <div className="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-3">
            ...
            <p className="text-xs text-blue-700 font-semibold">
              Demo payment mode is enabled. Payments
