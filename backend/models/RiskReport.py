...
class RiskReport(Base):
    ...
    # ------------------------------------------------------------------
    # AI usage flag
    # True  → recommendation was generated by Gemini API.
    # False → rule-based fallback was used (quota, error, no key).
    # Set at write-time in riskController.analyze_vendor(); never inferred
    ...
    ai_used = Column(
        ...
        comment="True when Gemini API generated the recommendation; False for rule-based fallback.",
    )
